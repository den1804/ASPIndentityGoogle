...
using Owin;
using ASPIndentityGoogle.Models;

namespace ASPIndentityGoogle
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            {
                ClientId = "205121228997-0ab22ku1elsk40hdmk4lmvel52i6tpjl.apps.googleusercontent.com",
                ClientSecret = "O72EKd12ifALZ27T_8tLcHH0"
            });
        }
    }
}